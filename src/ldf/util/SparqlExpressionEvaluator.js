...
import createErrorType from './CustomError';
...
export default SparqlExpressionEvaluator;
export { UnsupportedExpressionError, UnsupportedOperatorError, InvalidArgumentsNumberError };

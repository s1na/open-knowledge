...
import ExecutionLogger from '../util/ExecutionLogger'
import TriplePatternIterator from './TriplePatternIterator'

const Logger = ExecutionLogger('ReorderingGraphPatternIterator');
...
export default ReorderingGraphPatternIterator;
